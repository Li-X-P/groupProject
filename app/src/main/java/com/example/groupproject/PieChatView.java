    ...
    private void drawText(Canvas mCanvas, float textAngle, String kinds, float needDrawAngle) {
        ...
        if (textAngle >= 0 && textAngle <= 90) { //画布坐标系第一象限(数学坐标系第四象限)
            if (needDrawAngle < minAngle) { //如果小于某个度数,就把文字画在饼状图外面
                mCanvas.drawText(kinds, (float) (mRadius * 1.5 * Math.cos(Math.toRadians(textAngle))), (float) (mRadius * 1.5 * Math.sin(Math.toRadians(textAngle)))+rect.height()/2, mTextPaint);
            } else {
            ...
            if (needDrawAngle < minAngle) {
                mCanvas.drawText(kinds, (float) (-mRadius * 1.5 * Math.cos(Math.toRadians(180 - textAngle))), (float) (mRadius * 1.5 * Math.sin(Math.toRadians(180 - textAngle)))+rect.height()/2, mTextPaint);
            } else {
            ...
            if (needDrawAngle < minAngle) {
                mCanvas.drawText(kinds, (float) (-mRadius * 1.5 * Math.cos(Math.toRadians(textAngle - 180))), (float) (-mRadius * 1.5 * Math.sin(Math.toRadians(textAngle - 180)))+rect.height()/2, mTextPaint);
            } else {
            ...
            if (needDrawAngle < minAngle) {
                mCanvas.drawText(kinds, (float) (mRadius * 1.5 * Math.cos(Math.toRadians(360 - textAngle))), (float) (-mRadius * 1.5 * Math.sin(Math.toRadians(360 - textAngle)))+rect.height()/2, mTextPaint);
            } else {
